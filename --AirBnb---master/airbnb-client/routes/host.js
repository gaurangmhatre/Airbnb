...
function newListing(req,res) {
    ...
    module.exports.yourListings = function(req, res, next){
    	var json_response = '';
    	console.log("In your listings username "+ req.body.username + req.body.itemsPerPage + req.body.pageNo);
...
module.exports.editListing = function(req, res, next){
    var json_response = '';
    console.log("In editListing Requests "+ req.user);
    var payload = {'title': req.body.title, 'fromDate': req.body.fromDate, 'toDate': req.body.toDate, 'fixedPrice': req.body.fixedPrice, 'auctionPrice': req.body.auctionPrice, 'noOfGuests': req.body.noOfGuests, 'id': req.body.id};
    mq_client.make_request("editListing_queue", payload, function (err, result) {
