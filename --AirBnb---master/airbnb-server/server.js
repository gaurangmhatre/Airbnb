...
cnn.on('ready', function(){
  ...
  cnn.queue('user_track', function(q){
    ...
    cnn.queue('placeBid_queue', function(q){
        console.log("in the placeBid_queue");
        q.subscribe(function(message, headers, deliveryInfo, m){
            console.log("in the placeBid_queue  subcriber");
            auction.placeBid(message, function(err,res){
                cnn.publish(m.replyTo, res, {
                    contentType:'application/json',
                    contentEncoding:'utf-8',
                    correlationId:m.correlationId
    ...
    cnn.queue('updateAuctionTrips_queue', function(q){
        console.log("in the updateAuctionTrips_queue");
        q.subscribe(function(message, headers, deliveryInfo, m){
            console.log("in the updateAuctionTrips_queue  subcriber");
            auction.updateAuctionTrips(message, function(err,res){
                cnn.publish(m.replyTo, res, {
                    contentType:'application/json',
                    contentEncoding:'utf-8',
                    correlationId:m.correlationId
  ...
  cnn.queue('reviewList_queue', function(q){
	...
	cnn.queue('getAllBillDetails_queue', function(q){
	  ...
	  cnn.queue('getBillfromBillDate_queue', function(q){
		  console.log("in the getBillfromBillDate_queue queue");
		  q.subscribe(function(message, headers, deliveryInfo, m){
			  console.log("in the getBillfromBillDate_queue queue subcriber");
			  util.log(util.format( deliveryInfo.routingKey, message));
			  util.log("Message: "+JSON.stringify(message));
			  util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			  admin.getBillfromBillDate(message, function(err,res){
	  ...
	  cnn.queue('getBillfromBillMonth_queue', function(q){
		  console.log("in the getBillfromBillMonth_queue queue");
		  q.subscribe(function(message, headers, deliveryInfo, m){
			  console.log("in the getBillfromBillMonth_queue queue subcriber");
			  util.log(util.format( deliveryInfo.routingKey, message));
			  util.log("Message: "+JSON.stringify(message));
			  util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			  admin.getBillfromBillMonth(message, function(err,res){
	  ...
	  cnn.queue('getHostfromCity_queue', function(q){
		  console.log("in the getHostfromCity_queue queue");
		  q.subscribe(function(message, headers, deliveryInfo, m){
			  console.log("in the getHostfromCity_queue queue subcriber");
			  util.log(util.format( deliveryInfo.routingKey, message));
			  util.log("Message: "+JSON.stringify(message));
			  util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			  admin.getHostfromCity(message, function(err,res){
	  ...
	  cnn.queue('getUserfromCity_queue', function(q){
		  console.log("in the getUserfromCity_queue queue");
		  q.subscribe(function(message, headers, deliveryInfo, m){
			  console.log("in the getUserfromCity_queue queue subcriber");
			  util.log(util.format( deliveryInfo.routingKey, message));
			  util.log("Message: "+JSON.stringify(message));
			  util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			  admin.getUserfromCity(message, function(err,res){
  ...
  cnn.queue('getPaymentDetails_queue', function(q){
	...
	cnn.queue('editListing_queue', function(q){
		console.log("in the editListing_queue queue");
		q.subscribe(function(message, headers, deliveryInfo, m){
			console.log("in the editListing_queue queue subcriber");
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			host.editListing(message, function(err,res){
	...
	cnn.queue('deleteHost_queue', function(q){
		console.log("in the deleteHost_queue queue");
		q.subscribe(function(message, headers, deliveryInfo, m){
			console.log("in the deleteHost_queue queue subcriber");
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			user.deleteHost(message, function(err,res){
	...
	cnn.queue('deleteAccount_queue', function(q){
		console.log("in the deleteAccount_queue ");
		q.subscribe(function(message, headers, deliveryInfo, m){
			console.log("in the deleteAccount_queue  subcriber");
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			user.deleteAccount(message, function(err,res){
